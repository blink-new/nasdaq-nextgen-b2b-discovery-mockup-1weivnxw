...
export const StockSymbolPage: React.FC<MarketPageProps> = ({ onBack, onOpenAdvisor }) => {
  return (
...
// Market News Page
export const MarketNewsPage: React.FC<MarketPageProps> = ({ onBack, onOpenAdvisor }) => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="bg-white border-b border-gray-200">
...
// Market Indices Page
export const MarketIndicesPage: React.FC<MarketPageProps> = ({ onBack, onOpenAdvisor }) => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="bg-white border-b border-gray-200">
